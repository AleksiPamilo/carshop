...
export default function BetaNotification({ dictionary }: { dictionary: IDictionary }) {
    ...
    return (
        <dialog className="bg-transparent backdrop-blur-sm w-full h-screen z-[150] fixed justify-center items-center px-3" style={{ display: open ? "flex" : "none" }} open={open}>
            <div className="flex flex-col items-center justify-center w-full mt-12">
                <div className="max-w-[40rem] min-h-[15rem] mb-12 shadow-xl rounded-md p-4 flex flex-col gap-4 items-center justify-center border bg-zinc-100 dark:bg-zinc-900">
