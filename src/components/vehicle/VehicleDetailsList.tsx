...
export default function VehicleDetailsList({ vehicle }: { vehicle: IVehicle }) {
    ...
    return (
        <div className="flex flex-col gap-3 mt-4">
            ...
            <VehicleDetail label={dictionary.vehicles.powerHp} value={`${technicalInfo.power}`} separator />
            <VehicleDetail label={dictionary.vehicles.licensePlate} value={basicInfo.licensePlate} separator />
        </div>
    );
}